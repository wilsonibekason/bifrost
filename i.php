root@ubuntu:/var/www/html/whmcs/templates/lowendhostblue# cat header.tpl
<!DOCTYPE html>
<html lang="en">
...
<body data-phone-cc-input="{$phoneNumberInputStyle}">
    ...
    <section id="header">
        <div class="container">
            ...
            <a href="https://infectedgamehosting.com" class="logo"><img src="{$assetLogoPath}" alt="{$companyname}"></a>
            {else}
            <!-- <a href="{$WEB_ROOT}/index.php" class="logo logo-text">{$companyname}</a> -->
            <a href="https://infectedgamehosting.com" class="logo logo-text">{$companyname}</a>
            {/if}
        ...
        <div class="container{if $skipMainBodyContainer}-fluid without-padding{/if}">
            <div class="row">
                ...
                <div
                    ...
                    showbreadcrumb=true}
                    {/if}
                    root@ubuntu:/var/www/html/whmcs/templates/lowendhostblue#